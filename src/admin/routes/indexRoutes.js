...
const cityRoutes = require('./websiteManagement/cityRoutes'); // Ensure correct path
const helpSupportRoutes = require('../routes/helpSupport/chat'); // Ensure correct path
const logsRoute = require('../routes/logs/logsRoute'); // Ensure correct path
const twoWheelerRoute = require('../routes/twoWheelerManagement/twoWheelerRoutes'); // Ensure correct path
...
router.use('/helpSupport', helpSupportRoutes);
router.use('/logs', logsRoute);
router.use('/twoWheeler', twoWheelerRoute);
