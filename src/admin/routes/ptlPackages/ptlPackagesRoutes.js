...
router.get('/downloadCsv', checkCrudPermission('export'), PtlCtrl.downloadTrackingCsv);
...
router.post('/addExtraDimension', checkCrudPermission('isShow'), PtlCtrl.addExtraDimension);
router.post('/addPtlPackages', checkCrudPermission('isShow'), PtlCtrl.addManualPackage);
