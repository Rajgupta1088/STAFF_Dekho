...
const packageCalculation = async (pickupLatitude, pickupLongitude, dropLatitude, dropLongitude, packages, res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: 'please enter correct Latitude & Longitude', error: err.message || 'Something went wrong. Please try again later.' });
    }
};
