...
const InitiatePaymentSchema = new mongoose.Schema({
    ...
    isWalletPay: { type: Number, enum: [0, 1, 2], default: 0 }, // 0 => Online Payment, 1 => Wallet Pay , 2 => COD
    ...
    isCashPayment: {
        type: Number, enum: [0, 1], // 0 = Online, 1 = Cash 
        default: 0
    },
    ...
    extraPackage: { type: String },
    extraWeight: { type: String },
    extraDimension: { type: String },
