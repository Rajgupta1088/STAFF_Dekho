...
const appServiceRoutes = require('./appServiceRoutes'); // Ensure correct path
const chatRoutes = require('./chatRoutes'); // Ensure correct path
const { verifyToken, headerAuth } = require('../middleware/authentication');


router.use('/otp', otpRoutes);
router.use('/services', appServiceRoutes);
