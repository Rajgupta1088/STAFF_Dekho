...
const { orderAssign, saveDriverLocation, tripHistory, tripHistoryCount, updateOrderStatus, pickupOrder, pickupSendOtp, pickupVerifyOtp, ftlOrderAssign, ftlUpdateOrderStatus, bidding, singleOrderDetail, twoWheelerUpdateOrderStatus } = require('../controllers/serviceController')
...
router.post('/singleOrderDetail', singleOrderDetail);
router.post('/twoWheelerUpdateOrderStatus', twoWheelerUpdateOrderStatus);
